          ...
          {slice.primary.items && slice.primary.items.length > 0 && (
            <div className="py-4 md:py-8 space-y-4 md:space-y-6 mb-8 px-4">
              {slice.primary.items.map((item, index) => (
                <FadeInUp key={index}>
                  <div className="flex flex-col justify-center aspect-square bg-primary text-center  rounded-lg pt-14 pb-14 transition-all duration-300 ease-in-out hover:shadow-xl hover:translate-y-[-4px] hover:bg-white">
